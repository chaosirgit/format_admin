...
@section('body')
    <div style="margin: 10px;">
        <div style="margin-top: 10px;width: 100%;margin-left: 10px;">
            <button class="layui-btn layui-btn-normal layui-btn-radius" onclick="layer_show('添加新闻','{{url('admin/news_add')}}')">添加新闻</button>
        </div>
...
@section('script')
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#demo'
                ,url: '{{url('admin/news_list')}}' //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
                    {field: 'id', title: 'ID', minWidth:80, align: 'center', sort: true, fixed: 'left'}
                    ,{field: 'category_name', title: '分类名称', minWidth:80, align: 'center', fixed: 'left'}
                    ,{field: 'title', title: '标题', minWidth:80, align: 'center', fixed: 'left'}
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer_show('编辑','{{url('admin/news_add')}}?id='+data.id);
                }
            });
